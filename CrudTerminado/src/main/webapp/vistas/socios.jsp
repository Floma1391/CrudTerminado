...
<html>
    ...
    <body>
        ...
        <div class="container text-bg-light p-3">
            <span class="placeholder col-12 bg-warning text-center fs-1 fw-bold">SOCIOS ACTIVOS</span>
            <div class="row"> 
                
                <a class="btn btn-warning col-10 m-4 mx-auto" href="SociosController?accion=nuevo">Agregar Socio <i class="fa-sharp fa-solid fa-user-plus"></i></a>
