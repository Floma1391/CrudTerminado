...
<html>
    ...
    <body>        
        <div class="container container text-bg-light p-3" >
            <span class="placeholder col-12 bg-warning text-center fs-1 fw-bold">MODIFICAR SOCIO</span>
                <div class="row" >
                    <%
		    ...
		    %>
                    <form class="p-5" method="POST" action="SociosController?accion=actualizar">
                        ...
                        <button type="submit" class="btn btn-warning m-4" >Modificar </button>
